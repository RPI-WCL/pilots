...
if __name__ == '__main__':
	...
	db.addData(DataParser('../data/Hight Power King Air_2.txt', '|'))
	db.loadConfiguration('afterConfig.json', UnitConverter.UnitConverter('.u.json'))
	#print db.clusterNames()
	#print db.numofClusters()
	#print db.getAllClustersSize()
	viewer.visualize()
