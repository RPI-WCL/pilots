...
public class SpeedCheckCorrect extends PilotsRuntime {
    ...
    public SpeedCheckCorrect( String args[] ) {
        try {
            parseArgs( args );
        } catch (Exception ex) {
            ex.printStackTrace();
        ...
        errorSigs_.add( new ErrorSignature( ErrorSignature.CONST, 10.0, "No error" ) );

        Vector<Constraint> constraints1 = new Vector<Constraint>();
        constraints1.add( new Constraint( Constraint.GREATER_THAN, 25.0 ) );
        ...
        errorSigs_.add( new ErrorSignature( ErrorSignature.CONST, 0.0, "GPS failure", constraints2 ) );

        Vector<Constraint> constraints3 = new Vector<Constraint>();
        constraints3.add( new Constraint( Constraint.LESS_THAN, -25.0 ) );
        errorSigs_.add( new ErrorSignature( ErrorSignature.CONST, 0.0, "Pitot tube + GPS failure", constraints3 ) );
    ...
    public static void main( String[] args ) {
        SpeedCheckCorrect app = new SpeedCheckCorrect( args );
        app.startServer();
