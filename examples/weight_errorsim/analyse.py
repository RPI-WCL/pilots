...
if not test_bayes:
	...
	log_data = parse_log("atr72_corrected.txt", "ATR72")
	log_real_data = parse_log("atr72_real.txt", "ATR72_real")
	...
	real_weight = origin_data_cruse['w']
	error = 0
	...
	r = response_time(estimated_signature, real_signature, 10)
	...
	origin_data = open_pilots("testing_origin.pltdata")
	error_data = open_pilots("testing_error.pltdata")
	log_data = parse_log("atr72_bayes.txt", "ATR72_bayes")
	log_real_data = parse_log("atr72_real.txt", "ATR72_real")
	origin_data_cruse = get_parts(origin_data, cruise_phase)
	log_data_cruse = get_parts(log_data, cruise_phase)
	error_data_cruse = get_parts(error_data, cruise_phase)
