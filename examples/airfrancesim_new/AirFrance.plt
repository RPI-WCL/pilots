program AirFrance;
    ...
    correct
        s1: true_air_speed = sqrt(ground_speed*ground_speed + wind_speed_estimate*wind_speed_estimate -
			  	2*ground_speed*wind_speed_estimate*cos((PI/180)*(ground_angle-wind_angle_estimate)));
        s2: ground_speed = sqrt(true_air_speed*true_air_speed + wind_speed_estimate*wind_speed_estimate +
