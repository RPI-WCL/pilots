...
public class AirFranceDemo extends PilotsRuntime {
    ...
    public void getCorrectedData( SlidingWindow win,
                                  ...
                                  Value wind_speed_estimate, Value wind_speed_estimate_corrected,
                                  ...
                                  Value wind_angle_estimate, Value wind_angle_estimate_corrected,
        ...
        wind_speed_estimate.setValue( getData( "wind_speed_estimate", new Method( Method.Closest, "t" ) ) );
        ...
        wind_angle_estimate.setValue( getData( "wind_angle_estimate", new Method( Method.Closest, "t" ) ) );
        ...
        wind_speed_estimate_corrected.setValue( wind_speed_estimate.getValue() );
        ...
        wind_angle_estimate_corrected.setValue( wind_angle_estimate.getValue() );
        switch (mode.getMode()) {
        case 1:
            true_air_speed_corrected.setValue( Math.sqrt(ground_speed.getValue()*ground_speed.getValue()+wind_speed_estimate.getValue()*wind_speed_estimate.getValue()-2*ground_speed.getValue()*wind_speed_estimate.getValue()*Math.cos((Math.PI/180)*(ground_angle.getValue()-wind_angle_estimate.getValue()))) );
            break;
        case 2:
            ground_speed_corrected.setValue( Math.sqrt(true_air_speed.getValue()*true_air_speed.getValue()+wind_speed_estimate.getValue()*wind_speed_estimate.getValue()+2*true_air_speed.getValue()*wind_speed_estimate.getValue()*Math.cos((Math.PI/180)*(wind_angle_estimate.getValue()-air_angle.getValue()))) );
            break;
        }
    }
    ...
    public void startOutput_true_air_speed_out() {
        ...
        while (!isEndTime()) {
            ...
            Value wind_speed_estimate = new Value();
            Value wind_speed_estimate_corrected = new Value();
            ...
            Value wind_angle_estimate = new Value();
            Value wind_angle_estimate_corrected = new Value();
            Mode mode = new Mode();

            getCorrectedData( win_true_air_speed_out_, true_air_speed, true_air_speed_corrected, ground_speed, ground_speed_corrected, wind_speed, wind_speed_corrected, wind_speed_estimate, wind_speed_estimate_corrected, air_angle, air_angle_corrected, ground_angle, ground_angle_corrected, wind_angle, wind_angle_corrected, wind_angle_estimate, wind_angle_estimate_corrected, mode, frequency );
            ...
            try {
                sendData( OutputType.Output, 0, true_air_speed_out, error );
